...
export default function Intro() {
  ...
  return (
    ...
    <div className="row h-100 align-items-center justify-content-center mx-5">
      <div className="col-12 col-lg-5 d-flex justify-content-center mt-5">
      ...
      <div className="col-12 col-lg-5 d-flex justify-content-center  mt-md-5">
        <img className="mt-md-5 hover-glow" src="https://i.imgur.com/tYFkSng.png"></img>
      </div>
    </div>
  );
}
